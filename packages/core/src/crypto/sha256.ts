// Dependency-free SHA-256 (FIPS 180-4). Used by the artifact-hash evidence
// module to recompute sha256 over bytes served by an injected EvidenceStore.
//
...
/** SHA-256 digest of the input bytes (32-byte Uint8Array). */
export function sha256(bytes: Uint8Array): Uint8Array {
  ...
  // 64-bit big-endian length. Bit lengths beyond 2^32 are not required here.
